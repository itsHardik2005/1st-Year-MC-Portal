...
export default function NonCorePage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 space-y-10 font-sans">
      ...
      {/* Header Banner */}
      <div className="border-3 sm:border-4 border-black bg-purple-300 p-5 sm:p-8 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] sm:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-2 text-xs font-mono font-black bg-black text-purple-300 px-4 py-2 border-2 border-black shadow-[3px_3px_0px_0px_rgba(255,255,255,1)]">
            <Filter className="w-4 h-4 text-yellow-300 stroke-[3]" />
      ...
      <div className="space-y-4 pt-4">
        <div className="flex flex-wrap items-center justify-between border-b-4 border-black pb-3 gap-2">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <h2 className="text-xl sm:text-2xl font-black uppercase text-black tracking-tight">
              SELECT MODULE & SPECIFIC LECTURE FOR <span className="bg-purple-300 text-black px-2 py-0.5 border-2 border-black inline-block mt-1 sm:mt-0">[{selectedSubject}]</span>
            </h2>
          </div>
            ...
            >
              <div className="space-y-4">
                <div className="flex items-center justify-between gap-2">
                  <span className="bg-black text-purple-300 font-mono text-xs font-black px-3 py-1 border-2 border-black uppercase truncate">
                    {mod.moduleLabel}
                  </span>
                  <div className="flex items-center space-x-2 text-[10px] font-mono font-bold bg-purple-300 text-black px-2 py-0.5 border border-black shrink-0">
                  ...
                  <div className="space-y-1.5">
                    {mod.lectures.map((lec) => (
                      <button
                        ...
                        className="w-full text-left p-2 bg-purple-100 hover:bg-black hover:text-yellow-300 border-2 border-black font-black text-xs uppercase transition-all duration-150 transform hover:-translate-y-0.5 flex items-center justify-between group gap-2"
                      >
              ...
              <div className="mt-4 pt-3 border-t-3 border-black space-y-2">
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-purple-500 hover:bg-black text-white font-black text-xs uppercase border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all duration-200 transform hover:-translate-y-0.5 flex items-center justify-center space-x-1.5"
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-black text-purple-300 hover:bg-purple-400 hover:text-black font-black text-xs uppercase border-2 border-black shadow-[2px_2px_0px_0px_rgba(236,72,153,1)] transition-all duration-200 transform hover:-translate-y-0.5 flex items-center justify-center space-x-1"
                ...
                <div className="flex items-center justify-between text-[10px] font-mono font-bold text-zinc-600 px-1">
                  ...
                  <div className="flex items-center space-x-2">
                    <button onClick={() => handleLaunchModule(mod.id, undefined, "dark")} className="hover:text-purple-600 underline">DARK THEME</button>
                    <span>•</span>
